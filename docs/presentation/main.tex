...
\author{%
  Aadya Khatavkar \and Bakhodir Izzatulloyev \and Mahir Beylerov\\
...
\begin{frame}{SARIMA Methods (Bakhodir Izzatulloyev's Contribution)}
...
\vspace{0.3cm}
\textit{\small \textbf{Credit:} All SARIMA methodology and empirical results implemented and developed by Bakhodir Izzatulloyev}
\end{frame}
...
\begin{center}
  ...
  \normalsize
  \textbf{Aadya Khatavkar} (Lead) | \textbf{Bakhodir Izzatulloyev} | \textbf{Mahir Beylerov}\\
  University of Bonn
