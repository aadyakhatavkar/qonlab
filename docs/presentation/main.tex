...
\begin{frame}{Mean Breaks: SARIMA Results Table}
\begin{center}
  \fbox{\includegraphics[width=0.95\textwidth]{../../figures/mean/mean_results_comparison.png}}
\end{center}

\vspace{0.2cm}

\textbf{Key Finding (Bakhodir's SARIMA Work):}
\begin{itemize}
  \item \textbf{Single break:} SARIMA + oracle break dummy best (RMSE=1.455)
  \item \textbf{Multiple breaks:} Oracle with 2 dummies dramatically better (RMSE=0.985)
  \item Simple exponential smoothing competitive for single breaks
  \item Rolling SARIMA good when break date unknown
\end{itemize}
\end{frame}
